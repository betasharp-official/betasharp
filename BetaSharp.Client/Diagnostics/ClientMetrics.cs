...
internal static class ClientMetrics
{
    ...
    public static readonly MetricHandle<long> UploadPackets = MetricRegistry.Register<long>("client:upload_packets");
    public static readonly MetricHandle<long> DownloadPackets = MetricRegistry.Register<long>("client:download_packets");
