...
public class WorldRenderer : IWorldEventListener
{
    ...
    public void drawBlockBreaking(EntityPlayer entityPlayer, HitResult hit, ItemStack itemStack, float tickDelta)
    {
        ...
        BlockRenderer.RenderBlockByRenderType(world.Reader, world.Lighting, targetBlock, new BlockPos(hit.BlockX, hit.BlockY, hit.BlockZ), renderEngine, tessellator, 240 + (int)(damagePartialTime * 10.0F), true);
        tessellator.draw();
