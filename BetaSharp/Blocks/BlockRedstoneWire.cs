...
public class BlockRedstoneWire : Block
{
    ...
    public override Box? getCollisionShape(IBlockReader var1, int var2, int var3, int var4)
    {
        return null;
    }
    ...
    public override int getColorMultiplier(IBlockReader var1, int var2, int var3, int var4)
    {
        return 8388608;
    }
    ...
    public override bool isStrongPoweringSide(IBlockReader var1, int var2, int var3, int var4, int var5)
    {
